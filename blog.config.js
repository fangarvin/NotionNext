...
const BLOG = {
  AUTHOR: '老方的博客', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'http://www.fangjunping.com', // 网站地址
  KEYWORDS: '老方的博客, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '老方的博客', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '老方的博客', // 站点描述，被notion中的页面描述覆盖
